...
public class UserImageSQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String[] COLUMNS = {KEY_ID, KEY_TRANSACTION_ID, KEY_USER_ID, KEY_IMAGE_ID, KEY_IMAGE_URL, KEY_THUMBNAIL_IMAGE_URL, KEY_DATE_TIME};
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_USER_IMAGE_TABLE = "CREATE TABLE " + TABLE_NAME + "( "
                + "db_id INTEGER PRIMARY KEY AUTOINCREMENT, " + "transactionId TEXT, " + "userId TEXT, "
                + "imageId TEXT, " + "imageUrl TEXT, " + "thumbnailImageUrl TEXT, " + "dateTime TEXT )";
