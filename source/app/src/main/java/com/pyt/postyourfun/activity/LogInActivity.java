...
//
        ...
        progressDG.setMessage("Please wait...");
    }
    ...
    private void getGoogleProfileInformation() {
        try {
            if (Plus.PeopleApi.getCurrentPerson(mGoogleApiClient) != null) {
                ...
                Log.e(TAG, "User ID: " + userId + ", Name: " + personName + ", Username: " + userName
                            + ", email: " + email
                            + ", Birthday: " + birthday);
                google_ID = userId;
                google_email = email;
    ...
    private void setGoogle_Token(){
        ...
        AsyncTask<Void, Void, String> task = new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    token = GoogleAuthUtil.getToken(getApplicationContext(), accounts[2].name,
