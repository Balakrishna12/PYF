...
public class ViewImageFragment extends Fragment implements View.OnClickListener, GridViewImageInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gridViewImageAdapter = new GridViewImageAdapter(getActivity(), thumbImages, this);
    ...
    public void initView(){
        ...
        fullImages.clear();
        userImages.clear();
        userImages = imageSQLiteHelper.getAllImages();
        for (int i = 0; i < userImages.size(); i++){
            thumbImages.add(userImages.get(i).getThumbImageUrl());
            fullImages.add(userImages.get(i).getImageUrl());
        }
    ...
    private void zoomImageFromThumb(final View thumbView, String imageId) {
        ...
        containerView.getGlobalVisibleRect(finalBounds,
                globalOffset);
